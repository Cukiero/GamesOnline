...
var Playground = /** @class */ (function () {
    ...
    Playground.prototype.createCanvas = function () {
        ...
        this.canvas = canvas;
        //wywolanie getContext - tworzenie elementu canvas
        this.ctx = canvas.getContext('2d');
        this.parent.appendChild(canvas);
        this.canvasRect = canvas.getBoundingClientRect(); //polozenie wzgledem okna
    };
    ...
    Playground.prototype.saveScore = function (score) {
        $.ajax({
            url: '/api/games/savescore',
            type: 'POST',
            data: JSON.stringify({ gameId: "1", score: score }),
