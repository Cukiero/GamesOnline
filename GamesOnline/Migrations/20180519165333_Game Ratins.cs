...
{
    public partial class GameRatins : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserViews = table.Column<int>(nullable: false),
                    WindowType = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameHighScores", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GameHighScores_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GameHighScores_Games_GameId",
                        column: x => x.GameId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Date = table.Column<DateTime>(nullable: false),
                    GameId = table.Column<int>(nullable: false),
                    IsHighScore = table.Column<bool>(nullable: false),
                    Score = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameHighScores_ApplicationUserId",
                table: "GameHighScores",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_GameHighScores_GameId",
                table: "GameHighScores",
                column: "GameId");
